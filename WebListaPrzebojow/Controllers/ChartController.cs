...
namespace WebListaPrzebojow.Controllers
{
    public class ChartController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ChartID,ChartAlbumowID")] Chart chart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ChartID,ChartAlbumowID")] Chart chart)
        {
            if (id != chart.ChartID)
            {
                return NotFound();
