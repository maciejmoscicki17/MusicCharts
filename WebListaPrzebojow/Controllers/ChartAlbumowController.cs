...
namespace WebListaPrzebojow.Controllers
{
    public class ChartAlbumowController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ChartAlbumowID")] ChartAlbumow chartAlbumow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ChartAlbumowID")] ChartAlbumow chartAlbumow)
        {
