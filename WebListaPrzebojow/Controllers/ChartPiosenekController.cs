...
namespace WebListaPrzebojow.Controllers
{
    public class ChartPiosenekController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ChartPiosenekID,ChartID")] ChartPiosenek chartPiosenek)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ChartPiosenekID,ChartID")] ChartPiosenek chartPiosenek)
        {
