...
namespace WebListaPrzebojow.Controllers
{
    public class AlbumController : Controller
    {
        ...
        {
            var albumy = _context.albumDb.ToList();
            var listaPrzebojowContext = _context.albumDb.Include(a => a.Artysta);
            return View(albumy);
        }
        ...
        public async Task<IActionResult> Create([Bind("AlbumID,ArtystaID,Nazwa")] Album album)
        {
            ...
            ViewData["ArtystaID"] = new SelectList(_context.artystaDb, "ArtystaID", "Pseudonim", album.ArtystaID);
            return View(album);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlbumID,ArtystaID,Nazwa")] Album album)
        {
            if (id != album.AlbumID)
            {
                return NotFound();
